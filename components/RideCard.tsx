...
const RideCard = ({ ride: {
    ...
    return (
        <View className="flex flex-row text-center justify-center bg-white rounded-lg shadow-sm shadow-neutral-300 mb-3">
            <View className="flex flex-col items-center justify-center p-3">
                ...
                <View className="flex flex-col w-full mt-5 bg-general-500 rounded-lg p-3 items-start justify-center">
                    ...
                    <View className="flex flex-row items-center w-full justify-between mb-5">
                        ...
                        <Text className={`text-md font-JakartaMedium capitalize ${payment_status === 'paid' ? 'text-green-500' : 'text-red-500'}`}>{payment_status}</Text>
                    </View>
                </View>
